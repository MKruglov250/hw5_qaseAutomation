...
public class TestCasePage {
    ...
    SelenideElement descriptionInput = $x("//p[contains(@data-placeholder,'For example')]");
    SelenideElement preconditionInput = $$("p[data-placeholder='Empty value']").get(0);
    SelenideElement postconditionInput = $$("p[data-placeholder='Empty value']").get(0);
    SelenideElement stepActionInput = $x("//p[@data-placeholder='Step Action']");
    SelenideElement stepDataInput = $x("//p[@data-placeholder='Data']");
    SelenideElement stepResultInput = $x("//p[@data-placeholder='Expected result']");
